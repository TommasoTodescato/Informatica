namespace GiocoVita
{
    internal class CConiglio : CPersonaggio, IMovable
    {
        public override Bitmap Img { get { return Properties.Resources.coniglio; } }
        public override int Hierarchy { get { return 1; } }

        public CConiglio((int x, int y) position) : base(position) { }
